...
class Order(Base, TimestampMixin):
    ...
    bill: Mapped["Bill"] = relationship("Bill", back_populates="orders")
...
class OrderItemMaid(Base):
    ...
    order_item: Mapped["OrderItem"] = relationship(
        "OrderItem", back_populates="selected_maids"
    )
    maid: Mapped["Maid"] = relationship("Maid", back_populates="order_item_maids")
