...
from app.schemas.session import CurrentSessionRead, SessionCreate, SessionRead, SessionUpdate
...
def list_sessions(db: Session = Depends(get_db)):
    stmt = select(SessionModel).order_by(SessionModel.service_date.desc(), SessionModel.id.desc())
